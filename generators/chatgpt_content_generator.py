...
class ChatGPTContentGenerator:
    ...
    def get_md(self, theme, heading, evidences):
        ...
        for i, evidence in enumerate(evidences):
            ...
            self.chatgpt_handler.send_prompt_and_generate_content(prompt, repeat_count=2)
    ...
    def get_permalink(self):
        ...
        permalink = self.chatgpt_handler.get_content(os.getenv("PERMALINK_PROMPT"), repeat_count=0)
    ...
    def get_keywords(self):
        ...
        keywords = self.chatgpt_handler.get_content(os.getenv("KEYWORDS_PROMPT"), repeat_count=0)
