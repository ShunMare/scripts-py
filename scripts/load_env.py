...
# **Create blog detail related variables**
...
CREATE_BLOG_DETAIL_EXCEL_FILE_PATH = get_env("CREATE_BLOG_DETAIL_EXCEL_FILE_PATH")
CREATE_BLOG_DETAIL_EXCEL_GROUP_SIZE = get_env("CREATE_BLOG_DETAIL_EXCEL_GROUP_SIZE", 10, int)
CREATE_BLOG_DETAIL_EXCEL_INDEX_ROW = get_env("CREATE_BLOG_DETAIL_EXCEL_INDEX_ROW", 1, int)
CREATE_BLOG_DETAIL_EXCEL_START_ROW = get_env("CREATE_BLOG_DETAIL_EXCEL_START_ROW", 2, int)
