...
CREATE_BLOG_WP_GET_EVIDENCE_BING_FILE_NAME = get_env(
...
CHATGPT_OUTPUT_ELEMENT = get_env("CHATGPT_OUTPUT_ELEMENT")
...
BING_OUTPUT_ELEMENT = get_env("BING_OUTPUT_ELEMENT")
...
EXECUTE_CREATE_BLOG_WP_GET_EVIDENCE_BING = (
    get_env("EXECUTE_CREATE_BLOG_WP_GET_EVIDENCE_BING", "false").lower() == "true"
)
...
# get evidence
CREATE_BLOG_WP_GET_EVIDENCE_PROMPT = get_env("CREATE_BLOG_WP_GET_EVIDENCE_PROMPT")
CREATE_BLOG_WP_GET_EVIDENCE_TAG = get_env("CREATE_BLOG_WP_GET_EVIDENCE_TAG")
CREATE_BLOG_WP_GET_EVIDENCE_CLASSES = get_env("CREATE_BLOG_WP_GET_EVIDENCE_CLASSES")
CREATE_BLOG_WP_GET_EVIDENCE_ATTRIBUTE_KEY = get_env(
    "CREATE_BLOG_WP_GET_EVIDENCE_ATTRIBUTE_KEY"
)
CREATE_BLOG_WP_GET_EVIDENCE_ATTRIBUTE_VALUE = get_env(
    "CREATE_BLOG_WP_GET_EVIDENCE_ATTRIBUTE_VALUE"
)
# ----------------------------
# Chatgpt variables
# ----------------------------
